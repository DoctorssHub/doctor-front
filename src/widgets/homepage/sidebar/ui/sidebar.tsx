    ...
    <>
      {isMobileOpen ? (
        <button
          ...
          className="fixed inset-x-0 bottom-0 top-16 z-90 cursor-default bg-black/50 min-[1280px]:hidden"
      ...
      <div className="flex h-full w-full flex-col items-center justify-start gap-3 pt-3">
        ...
        <a
          ...
          className={`-mx-4 mt-auto flex h-20 w-[calc(100%+32px)] items-center border-t border-[#1b1f26] p-4 text-[18px] font-medium text-(--color-text-primary) transition hover:bg-(--color-surface-hover) ${
