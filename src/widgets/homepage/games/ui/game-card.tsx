...
export function GameCard({ game }: GameCardProps) {
  return (
    <Link
      ...
      className="group relative block h-[230px] w-[275px] overflow-hidden rounded-xl border border-(--color-border) border-b-[3px] bg-(--color-surface-game) transition duration-300 hover:-translate-y-1 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--color-text-primary) min-[1024px]:max-[1279px]:h-[190px] min-[1024px]:max-[1279px]:w-[228px] min-[768px]:max-[1023px]:h-[191px] min-[768px]:max-[1023px]:w-full max-[767px]:h-[191px] max-[767px]:w-full"
      href={game.href}
      style={{
        background: "#0e1519",
