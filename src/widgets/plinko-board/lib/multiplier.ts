...
export function multiplierGlow(multiplier: number): string {
  if (multiplier >= 4) {
    return "shadow-[0_0_20px_rgb(239_68_68/42%)]";
  }

  if (multiplier >= 1.3) {
    return "shadow-[0_0_20px_rgb(249_115_22/42%)]";
  }

  if (multiplier >= 1) {
    return "shadow-[0_0_20px_rgb(250_204_21/42%)]";
  }

  return "shadow-[0_0_20px_rgb(34_197_94/42%)]";
}
