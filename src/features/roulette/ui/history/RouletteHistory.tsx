...
export const RouletteHistory = memo(function RouletteHistory({
  ...
  return (
    <div
      ...
      className="pointer-events-none absolute left-4 top-5 z-10 flex flex-col justify-start gap-2 max-tablet:top-1/2 max-tablet:left-4 max-tablet:-translate-y-1/2"
    >
