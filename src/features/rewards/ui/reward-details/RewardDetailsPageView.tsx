...
export function RewardDetailsPageView({
  ...
  return (
    <main className="min-h-screen bg-(--color-page) text-(--color-text-primary)">
      <div className="rewards-detail-entrance mx-auto flex w-full max-w-[900px] flex-col gap-5 px-6 py-9 max-tablet:px-4 max-tablet:py-7">
        <Link
          className="rewards-detail-back-entrance inline-flex w-fit items-center gap-3 text-[18px] leading-[133%] font-medium text-(--color-text-primary) transition hover:text-(--color-brand)"
          href="/rewards"
        >
          <span
            aria-hidden="true"
        ...
        {reward ? (
          <article className="flex flex-col gap-5">
            <div className="rewards-detail-image-entrance relative h-100 overflow-hidden rounded-[16px] bg-[#12171d] max-tablet:h-65 max-mobile:h-[220px]">
              <Image
                alt={reward.title}
            ...
            <div className="rewards-detail-heading-entrance flex items-start justify-between gap-6 max-tablet:flex-col max-tablet:gap-4">
            ...
            <div className="rewards-detail-content-entrance">
