...
const KENO_TILES = Array.from({ length: 40 }, (_, index) => index + 1);
  ...
  return (
    <div className="mx-auto grid w-[576px] grid-cols-8 gap-1">
      {KENO_TILES.map((tile) => {
        ...
        return (
          <div
            className={`grid size-[67px] place-items-center rounded-[12px] border border-[rgba(63,74,89,0.5)] bg-[linear-gradient(180deg,#1b1f26_0%,#2b303b_100%)] px-3 py-[18px] text-center text-xl font-semibold text-[#fdfdfd] ${
              isSelected
